...
<div class="relative w-full h-screen bg-white dark:bg-gray-900">
    ...
    <div class="absolute hidden w-full bg-green-600 dark:bg-green-700 lg:block h-screen"></div>
    ...
    <div class="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <form action="/products/purchase" method="POST" id="purchase-form" class="mt-10">
            ...
            <div class="credit-card-wrapper">
                ...
                <div class="form-group text-center">
                    ...
                    <button id="card-button" data-secret="{{ $intent->client_secret }}" class="btn btn-lg btn-success w-full bg-green-600 text-white py-2 rounded">{{ __('Purchase') }}</button>
